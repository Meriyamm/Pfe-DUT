...
class PolarQuestion extends Question {
  PolarQuestion(
      ...
      List<IconData> this.answers = const [Icons.thumb_up, Icons.thumb_down],
      this.parent,
...
class NestedQuestion extends PolarQuestion {
  NestedQuestion(
      {@required question,
      answers = const [Icons.thumb_up, Icons.thumb_down],
      children,
      parent,
      isMandatory = false})

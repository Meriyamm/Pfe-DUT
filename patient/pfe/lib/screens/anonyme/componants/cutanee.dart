...
class CutAdvice extends StatelessWidget {
  const CutAdvice({Key key}) : super(key: key);
                    ...
                    child: Column(
                      children: [
                        ...
                        Directionality(
                          ...
                          child: Text(
                            'ترطيب جيد \nحمام دافئ ودش \nلبس ملابس فضفاضة (قطن وكتان) \nصابون جلدي محايد بدرجة حموضة / صابون أو صابونملف بدلا من قص الأظافر \nاجعل أظافر الأصابع قصيرة \nلبس حذاء مريح \nتجنب حدوث أي صدمة للأطراف \nمقوي للورنيش ، كريمات مغذية \nتجنب الأظافر الصناعية والمذيبات التي تحتوي على الأسيتون والصابون المعطر. \ليسالحماية من أشعة الشمس \n',
                            style:
                                TextStyle(fontFamily: 'DMSans', fontSize: 17),
                          ),
                        ),
                      ],
                    ),
